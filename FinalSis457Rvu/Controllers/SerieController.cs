...
using FinalSis457Rvu.Models;

namespace FinalSis457Rvu.Controllers
{
    [Authorize]
    public class SerieController : Controller
    {
        private readonly FinalSis457RvuContext _context;

        public SerieController(FinalSis457RvuContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
             ...
             //usuario.Usuario1 = "usrrvu";
             //usuario.Clave = AccountController.Encrypt("hola123");
            ...
            return _context.Series != null ?
              ...
              Problem("Entity set 'FinalSis457RvuContext.Series'  is null.");
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FinalSis457RvuContext.Serie'  is null.");
            }
            var serie = await _context.Series.FindAsync(id);
            if (serie != null)
            {
